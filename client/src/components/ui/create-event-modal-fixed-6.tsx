...
/**
 * Função simplificada para focar em um input
 * Esta abordagem é mais compatível com todos os ambientes
 */
const focusInputElement = (inputId: string) => {
  try {
    ...
    console.error(`Erro ao focar no input ${inputId}:`, error);
  }
};
                      ...
                      <div className="relative flex items-center">
                        ...
                        <Button 
                          ...
                          onClick={() => {
                            ...
                            if (input) {
                              input.showPicker = function() {}; // Para evitar erros
                              input.focus();
                            }
                          }}
                        >
